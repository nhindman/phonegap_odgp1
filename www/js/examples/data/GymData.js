define(function(require, exports, module) {
  ...
  var GymData = function() {
    ...
    return {
      ...
      "gym_list_placeholders": ["gym_placeholder1.jpg", "gym_placeholder2.jpg", "gym_dummy_3.jpg", "gym_placeholder3.jpg", "gym_placeholder4.jpg", "gym_placeholder2.jpg", "gym_placeholder1.jpg", "gym_dummy_3.jpg", "black_rectangle.jpg"],
      "one_day_price": ["$9", "$9", "$12", "$15", "$5", "$7", "$18", "$7", ""], 
      "four_day_price": ["$20", "$14", "$17", "$40", "$10", "$12", "$25", "$20", ""], 
      "one_month_price": ["$80", "$70", "$34", "$115", "$20", "$15", "$36", "$40"]
    }
  };
